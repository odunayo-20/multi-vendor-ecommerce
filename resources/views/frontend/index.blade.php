        ...
        <div class="cat-blocks-container">
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="{{route('frontend.product', $category->slug)}}" class="cat-block">
                        <figure>
                            <span>
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
            <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    @forelse ($productLatest as $productValue)
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-top">New</span>
                            <a href="{{route('frontend.product.view', [$productValue->category->slug, $productValue->slug])}}">
                                @if ($productValue->productImages->count() > 0)

                                <img src="{{asset($productValue->productImages[0]->image)}}" alt="{{$productValue->name}}" class="product-image">
                                @endif
                            </a>
                        ...
                        <div class="product-body">
                            <div class="product-cat">
                                <a href="#" class="text-captalize">{{$productValue->brand->name}}</a>
                            </div><!-- End .product-cat -->
                            <h3 class="product-title"><a href="{{route('frontend.product.view', [$productValue->category->slug, $productValue->slug])}}" class="text-capitalize">{{$productValue->name}}</a></h3><!-- End .product-title -->
                            <div class="product-price">
                               N{{number_format($productValue->selling_price, 2)}}
                    ...
                    <div class="tab-content tab-content-carousel just-action-icons-sm">
                        <div class="tab-pane p-0 fade show active" id="trending-top-tab" role="tabpanel" aria-labelledby="trending-top-link">
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                                ...
                                @forelse ($productTreading as $productValue)
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-top">Top</span>
                                        <a href="{{route('frontend.product.view', [$productValue->category->slug, $productValue->slug])}}">
                                            ...
                                            <img src="{{asset($productValue->productImages[0]->image)}}" alt="Product image" class="product-image">
                                            @endif
                                        </a>
                                        ...
                                        <div class="product-action">
                                            <a href="#" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a>
                                            <a href="{{route('frontend.product.view', [$productValue->category->slug, $productValue->slug])}}" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                                        </div><!-- End .product-action -->
                                    </figure><!-- End .product-media -->

                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#" class="text-capitalize">{{$productValue->brand->name}}</a>
                                        </div><!-- End .product-cat -->
                                        <h3 class="product-title"><a href="{{route('frontend.product.view', [$productValue->category->slug, $productValue->slug])}}" class="text-capitalize">{{$productValue->name}}</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            N{{number_format($productValue->selling_price, 2)}}
