                    ...
                    <div class="col-lg-9 col-xl-4-5col">
                        <div class="category-banners-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl"
                            ...
                            <div class="banner banner-poster">
                                ...
                                <a href="#">
                                    <img src="{{asset('frontend/assets/images/demos/demo-13/banners/banner-7.jpg')}}" alt="Banner">
                                </a>
                            ...
                            <div class="banner banner-poster">
                                <a href="#">
                                    <img src="{{asset('frontend/assets/images/demos/demo-13/banners/banner-8.jpg')}}" alt="Banner">
                                </a>
                        ...
                        <div class="owl-carousel owl-simple owl-nav-top carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <a href="{{route('frontend.product.view', [$category->slug, $featuredValue->slug]) }}">
                                        <img src="{{asset($featuredValue->productImages[0]->image)}}" alt="{{$featuredValue->name}}" class="product-image">
                                    </a>

                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to wishlist</span></a>
                                        {{-- <a href="#" class="btn-product-icon btn-compare" title="Compare"><span>Compare</span></a> --}}
                                        <a href="{{route('frontend.product.view', [$featuredValue->category->slug, $featuredValue->slug])}}" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick view</span></a>
                                ...
                                <div class="product-body">
                                    <div class="product-cat">
                                        <a href="#">{{$featuredValue->brand->name}}</a>
                                    </div><!-- End .product-cat -->
                                    <h3 class="product-title"><a href="{{route('frontend.product.view', [$featuredValue->category->slug, $featuredValue->slug])}}">{{$featuredValue->name}}</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        N{{number_format($featuredValue->selling_price, 2)}}
