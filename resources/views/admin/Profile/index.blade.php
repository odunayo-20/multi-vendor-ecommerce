              ...
              <div class="padding-20">
                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                  ...
                  <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="profile-tab2">
                    <form action="{{route('admin.profile.edit', Auth::guard('admin')->user()->id )}}" method="post" enctype="multipart/form-data">
                      <div class="card-header">
                        <h4>Edit Profile</h4>
                      </div>
                      <div class="card-body">
                        <div class="row">
                          <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" name="first_name" class="form-control" value="{{ Auth::guard('admin')->user()->first_name }}">
                          ...
                          <div class="form-group col-md-6 col-12">
                            ...
                            <input type="text" name="last_name" class="form-control" value="{{ Auth::guard('admin')->user()->last_name }}">
                            <div class="invalid-feedback">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-5 col-12">
                            <label>Phone</label>
                            <input type="tel" name="phone" class="form-control" value="{{ Auth::guard('admin')->user()->phone }}">
                          </div>
